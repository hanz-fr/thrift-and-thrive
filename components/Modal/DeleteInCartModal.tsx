...
const DeleteInCartModal: React.FC<DeleteInCartProps> = ({ isOpen, onClose, onConfirm, product }) => {
    return (
        <Modal isOpen={isOpen} onOpenChange={onClose}>
            <ModalContent>
                <>
                    <ModalHeader className="flex flex-col gap-1">Remove from Cart?</ModalHeader>
                    <ModalBody>
