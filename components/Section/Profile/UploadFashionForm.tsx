...
import { Card, CardHeader, CardBody, Avatar, Tabs, Tab, Button, Input, Textarea, Select, Modal, SelectItem } from "@heroui/react";
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className=" w-full p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <CardHeader>
                    <label htmlFor="avatar-upload" className="cursor-pointer">
                        {form.images.length > 0 ? (
                            ...
                            <Avatar src="/placeholder-avatar.png" alt="User" />
                        )}
            ...
            <div>
                <CardBody className="grid gap-4">
                    ...
                    <Button className="w-full" onClick={handleSubmit}>Upload Produk</Button>
                </CardBody>
            </div>
