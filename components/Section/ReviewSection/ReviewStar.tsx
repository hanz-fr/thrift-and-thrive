        ...
        <div className="inline-flex items-center">
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill={props.rating >= 1 ? "#00000" : "none"}
          ...
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill={props.rating >= 2 ? "#00000" : "none"}
              className="w-6 h-6 text-yellow-700 cursor-pointer"
            >
              <path
                fillRule="evenodd"
          ...
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill={props.rating >= 3 ? "#00000" : "none"}
              className="w-6 h-6 text-yellow-700 cursor-pointer"
            >
              <path
                fillRule="evenodd"
          ...
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill={props.rating >= 4 ? "#00000" : "none"}
              className="w-6 h-6 text-yellow-700 cursor-pointer"
            >
              <path
                fillRule="evenodd"
          ...
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill={props.rating >= 5 ? "#00000" : "none"}
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              stroke="currentColor"
